...
public class CardNum {
	...
	public static final String[] MASTERCARD_PREFIX_LIST = new String[] { "622262"};
...
//			howMany = Integer.parseInt(args[0]);
		...
		String creditcardnumbers = generateMasterCardNumber();
			System.out.println(creditcardnumbers
					+ ":"
					+ (isValidCreditCardNumber(creditcardnumbers) ? "valid"
							: "invalid"));
	}
}
