...
public class FirebirdTypeConvert implements ITypeConvert {
    ...
    public IColumnType processTypeConvert(GlobalConfig config, String fieldType) {
        return TypeConverts.use(fieldType)
            .test(TypeConverts.containsAny("cstring", "text").then(STRING))
            .test(TypeConverts.contains("short").then(SHORT))
            .test(TypeConverts.contains("long").then(LONG))
            ...
            .test(TypeConverts.contains("int64").then(LONG))
