...
public class TemplateConfig {
    ...
    private String entityDto = ConstVal.TEMPLATE_ENTITY_DTO;
    private String entityAddDto = ConstVal.TEMPLATE_ENTITY_ADD_DTO;
    private String entityUpdDto = ConstVal.TEMPLATE_ENTITY_UPD_DTO;
    private String entityVo = ConstVal.TEMPLATE_ENTITY_VO;
    private String entityMapper = ConstVal.TEMPLATE_ENTITY_MAPPER;
