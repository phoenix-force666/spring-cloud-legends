package top.legendscloud.file.aspect;

import top.legendscloud.file.annotation.ValidFile;
import top.legendscloud.file.exception.FileValidationException;
import top.legendscloud.file.util.FileTypeUtils;
...
public class FileTypeAspect {
        ...
        @Pointcut("@annotation(top.legendscloud.file.annotation.ValidFile)")
