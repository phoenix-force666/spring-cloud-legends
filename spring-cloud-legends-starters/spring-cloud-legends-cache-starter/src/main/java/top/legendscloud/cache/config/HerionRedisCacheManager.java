 ...
 * 通过自定义  HerionRedisCacheManager 并继承 RedisCacheManager 来处理异常可以解决这个问题。
 */
@Slf4j
public class HerionRedisCacheManager extends RedisCacheManager implements ApplicationContextAware, InitializingBean {
    ...
    public HerionRedisCacheManager(RedisCacheWriter cacheWriter, RedisCacheConfiguration defaultCacheConfiguration) {
...
//            CacheExpire cacheExpire = findCacheDuration(clazz,method);
            ...
            if (cacheable != null) {
                addCacheExpires(cacheable.cacheNames(), cacheExpire);
                return;
            }
            ...
            if (caching != null) {
                ...
                if (cs.length > 0) {
                    for (Cacheable c : cs) {
                        if (cacheExpire != null && c != null) {
                            addCacheExpires(c.cacheNames(), cacheExpire);
                        }
                    }
                }
            } else {
                ...
                if (cacheConfig != null) {
                    addCacheExpires(cacheConfig.cacheNames(), cacheExpire);
                }
            }
    ...
    /**
     * @Author herion
     * @Description 标注的有效期，优先使用方法上标注的有效期
     * @Date  2019/5/20
     * @Param [clazz, method]
     * @return CacheExpire
     **/
    ...
    private void addCacheExpires(String[] cacheNames, CacheExpire cacheExpire) {
    ...
    protected static class RedisCacheWrapper implements Cache {
        ...
        public <T> T get(Object o, Class<T> aClass) {
            // System.out.println("get ---> o: {}, clazz: {}", o, aClass);
            try {
